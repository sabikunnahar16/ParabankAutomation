...
class Program
{
    static void Main(string[] args)
    {
        ...
        string reportFilePath = $@"D:\QA\ParabankAutomation\report\Report_{dateTime}.html";
        ...
        try
        {
            ...
            using (var reader = new StreamReader(@"\D:\QA\ParabankAutomation\data.csv"))
    ...
    {
        test.Log(Status.Info, $"Sabikunnahr \nDept of CSE \nJagannath University, Dhaka \n\n");
